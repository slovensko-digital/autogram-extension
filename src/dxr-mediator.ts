...
import { DsignerRequest } from "./dsigner-mediator";

export interface DxrData {
  Data: string;
...
export class DxrMediator {
  static updateSignedForm(
    response: SignerResponse,
    request: DsignerRequest
  ): string {
    const data: DxrData = {
      Data: btoa(response.content),
      SignatureType: request.SignatureType,
      SignatureMetadata: {
        ...request.SignatureMetadata,
        MimeType: "application/xml"
      },
      InternalDocumentIds: request.InternalDocumentIds,
      InternalDocumentSignatureContainerIds:
        request.InternalDocumentSignatureContainerIds,
    };

    const fakeData: DxrData = {
    ...
    return "Action|sign|Data|" + JSON.stringify(data);
  }
}
